			...
			<tr>
				...
				<td width="50%" style="border-color: #eaebed;">
					<p>
						...
						<center>
							<a
								href="http://controlasies.com.co/"
								style="background-color: #00afc9; padding: 15px 20px; border-radius: 3px; text-transform: uppercase; color: white; text-decoration: none;"
								target="_blank"
							>
